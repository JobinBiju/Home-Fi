...
class Temperature {
    ...
    factory Temperature.fromJson(Map<String, dynamic> json) => Temperature(
        ...
        feedWebhookReceivers: List<dynamic>.from(json["feed_webhook_receivers"].map((x) => x)),
        feedStatusChanges: List<dynamic>.from(json["feed_status_changes"].map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "feed_webhook_receivers": List<dynamic>.from(feedWebhookReceivers!.map((x) => x)),
        "feed_status_changes": List<dynamic>.from(feedStatusChanges!.map((x) => x)),
    };
}
